    ...
    function loadEngContent() {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                document.querySelector('#main-01').querySelector('.text-box').querySelector('span').innerHTML = JSON.parse(xhr.responseText).firstScreen_03_text;
                document.querySelector('#main-01').querySelector('.foot-01').querySelector('em').innerHTML = JSON.parse(xhr.responseText).firstScreen_04_text;
                document.querySelector('#main-01').querySelector('.foot-01').querySelector('strong').innerHTML = JSON.parse(xhr.responseText).firstScreen_05_text;
                ...
                document.querySelector('#main-02').querySelector('.first-screen').querySelectorAll('span')[0].innerHTML = JSON.parse(xhr.responseText).secondScreen_firstLayout_03_text;
                ...
                document.querySelector('#main-02').querySelector('.second-screen').querySelectorAll('span')[0].innerHTML = JSON.parse(xhr.responseText).secondScreen_secondLayout_03_text;
                ...
                document.querySelector('#main-02').querySelector('.three-screen').querySelectorAll('span')[0].innerHTML = JSON.parse(xhr.responseText).secondScreen_thirdLayout_03_text;
                ...
                document.querySelector('#main-02').querySelector('.four-screen').querySelectorAll('span')[0].innerHTML = JSON.parse(xhr.responseText).secondScreen_fourthLayout_03_text;
                ...
                document.querySelector('#main-02').querySelector('.five-screen').querySelectorAll('span')[0].innerHTML = JSON.parse(xhr.responseText).secondScreen_fifthLayout_03_text;
                ...
                document.querySelector('#main-02').querySelector('.six-screen').querySelectorAll('span')[0].innerHTML = JSON.parse(xhr.responseText).secondScreen_sixthLayout_03_text;
                ...
                document.querySelector('#main-03').querySelector('.text-box').querySelector('strong').innerHTML = JSON.parse(xhr.responseText).thirdScreen_02_text;
                ...
                document.querySelector('#main-03').querySelector('.foot-02').querySelector('em').innerHTML = JSON.parse(xhr.responseText).thirdScreen_08_text;
                document.querySelector('#main-03').querySelector('.foot-02').querySelector('strong').innerHTML = JSON.parse(xhr.responseText).thirdScreen_09_text;
                ...
                document.querySelector('#main-04').querySelector('.text-box').querySelector('strong').innerHTML = JSON.parse(xhr.responseText).fourthScreen_02_text;
                ...
                document.querySelector('#main-04').querySelector('.foot-02').querySelector('em').innerHTML = JSON.parse(xhr.responseText).fourthScreen_08_text;
                document.querySelector('#main-04').querySelector('.foot-02').querySelector('strong').innerHTML = JSON.parse(xhr.responseText).fourthScreen_09_text;
                document.querySelector('#main-05').querySelector('.text-box').querySelector('em').innerHTML = JSON.parse(xhr.responseText).fifthScreen_01_text;
                ...
                document.querySelector('#main-05').querySelector('.foot-01').querySelector('em').innerHTML = JSON.parse(xhr.responseText).fifthScreen_04_text;
                document.querySelector('#main-05').querySelector('.foot-01').querySelector('strong').innerHTML = JSON.parse(xhr.responseText).fifthScreen_05_text;
