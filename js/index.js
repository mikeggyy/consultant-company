...
window.addEventListener("load", function () {
    ...
    if ($(window).width() < 992) {
        ...
        // 滑鼠滾輪整屏移動
        nav.querySelectorAll("span")[0].style.transition = ".5s ease";
        nav.querySelectorAll("span")[1].style.transition = ".5s ease";
        nav.querySelectorAll("span")[2].style.transition = ".5s ease";
        nav.querySelectorAll("span")[3].style.transition = ".5s ease";
        nav.querySelectorAll("span")[4].style.transition = ".5s ease";
